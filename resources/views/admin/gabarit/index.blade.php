...
<div class="col-md-6">
    ...
    <div class="box box-info">
        ...
        <div class="box-footer clearfix">
            {!! Button::info('Ajouter')->asLinkTo(route('admin.gabarit.create'))->small() !!}
        </div>
        <!-- /.box-footer -->
    </div>
    <!-- /.box -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tab-admin').DataTable({
                serverSide: true,
                ajax: {
                    'url': '{{ route('admin.gabarit.index.ajax') }}'
                },
                columns: [
                    { 'data': 'id_gabarit' },
                    { 'data': 'type_gabarit' },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = "{!! Button::warning('Modifier')->asLinkTo(route('admin.gabarit.edit', 'dummyId'))->extraSmall()->block()->render() !!}";
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = '{!! BootForm::open()->action( route("admin.gabarit.destroy", "dummyId") )->attribute("onsubmit", "return confirm(\'Vraiment supprimer cet objet ?\')")->delete() !!}'
